meta <- data.frame(
  ...
  Omics = c("phosphoproteome, proteome, transcriptome", "phosphoproteome, proteome", "epigenome, phosphoproteome, proteome, transcriptome"),
...
write.table(meta, "../../extdata/manifest.txt", sep="\t")
